...
Have students verify their configuration by:

1. **Create authorization rule:** Check AWS Console → VPC → Client VPN Endpoints → Select endpoint → Authorization → Should see a rule for 10.0.0.0/16
2. **Check route table:** Console → Client VPN Endpoints → Select endpoint → Route Table → Should have entry: 10.0.0.0/16 → points to target subnet
3. **Verify security groups:** Console → EC2 → Instances → Select an instance → Security Groups → Inbound rules should allow source from 172.16.0.0/16 (or Client VPN SG)
4. **Test connectivity:** From VPN client, ping EC2 instance (if ICMP allowed) or SSH (if port 22 allowed)

***

This puzzle teaches students that **cloud security is layered**—authentication, authorization, routing, and instance-level firewalls must all be properly configured for end-to-end connectivity.
<span style="display:none">[^1][^10][^11][^12][^13][^14][^15][^2][^3][^4][^5][^6][^7][^8][^9]</span>

<div align="center">⁂</div>

[^1]: https://devopscube.com/aws-client-vpn/

[^2]: https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/split-tunnel-vpn.html

[^3]: https://www.youtube.com/watch?v=grwmzPT5JY4

[^4]: https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/client-authorization.html

[^5]: https://anirban28.hashnode.dev/aws-client-vpn-your-step-by-step-setup-guide

[^6]: https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/what-is-best-practices.html

[^7]: https://shisho.dev/dojo/providers/aws/Amazon_EC2/aws-ec2-client-vpn-authorization-rule/

[^8]: https://www.youtube.com/watch?v=h3tkqfZHSzM

[^9]: https://www.cloudthat.com/resources/blog/a-setup-guide-for-aws-client-vpn-with-on-premises-machines

[^10]: https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/describe-client-vpn-authorization-rules.html

[^11]: https://www.youtube.com/watch?v=VFiQ4w-jDRs

[^12]: https://www.netmaker.io/resources/aws-vpn

[^13]: https://www.bdrshield.com/blog/what-is-aws-client-vpn/

[^14]: https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/cvpn-working-routes.html

[^15]: https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/security-best-practices.html
